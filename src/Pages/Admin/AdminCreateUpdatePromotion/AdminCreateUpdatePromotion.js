      ...
      try {
        if (isUpdatePromotion) {
          ...
          await updatePromotion({
            variables: { record: newPromotion, promotionId },
          });
              ...
              <form className="flex flex-col" onSubmit={handleSubmitCreate}>
                ...
                <label className="inline-flex items-center">
                  <input
                    ...
                    value="Free"
                    onChange={handleInputChange}
                    checked={newPromotion.type === "Free"}
                  />
                  <span className="ml-2 mr-5">Free</span>
                </label>
                Buy
                <input
                  disabled={!(newPromotion.type === "Free")}
                  onChange={handleInputChange}
                  value={newPromotion.buy_get || ""}
                  type="text"
                  name="buy_get"
                  className={className_input}
                ></input>
                ...
                <label className="inline-flex items-center">
                  <input
                    ...
                    value="Sale"
                    onChange={handleInputChange}
                    checked={newPromotion.type === "Sale"}
                  />
                  <span className="ml-2">Sale</span>
                </label>
                Sale
                <input
                  disabled={!(newPromotion.type === "Sale")}
                  onChange={handleInputChange}
                  value={newPromotion.persent || ""}
                  type="text"
                  name="persent"
                  className={className_input}
                ></input>
                ...
                <div className="inline">
                  <label className="inline-flex items-center mt-3">
                    <input
                      onChange={handleInputChange}
                      defaultChecked={newPromotion.active}
                      type="checkbox"
                ...
                <button
                  type="button"
                  onClick={() => console.log(newPromotion)}
                  className="bg-green-400 hover:bg-green-500 text-white font-semibold py-2 px-4 border border-green-500 hover:border-transparent rounded w-max"
                >
                  Test Save Product
                </button>
              </form>
