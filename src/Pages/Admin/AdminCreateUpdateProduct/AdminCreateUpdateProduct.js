...
const AdminProduct = () => {
  ...
  const className_input =
    "shadow appearance-none border rounded w-6/12 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline";
            ...
            <div className="container bg-gray-50 px-16 ">
              ...
              <form className="flex flex-col" onSubmit={handleSubmitCreate}>
                ...
                >
                  ...
                  {CONFIG_CREATE_PRODUCT.PRODUCT_TYPE.select_value.map(
                    (value, i) => {
                      const select_input =
                        CONFIG_CREATE_PRODUCT.PRODUCT_TYPE.select_input[i];
                      return (
                ...
                >
                  <option value="">-- Please select one --</option>
                  {CONFIG_CREATE_PRODUCT.PRODUCT_COLOR.select_value.map(
                    (value, i) => {
                      const select_input =
                        CONFIG_CREATE_PRODUCT.PRODUCT_COLOR.select_input[i];
                      return (
                        <option key={i} value={value}>
                          {select_input}
                        </option>
                ...
                <div className="inline">
                  ...
                  {checked ? (
                    <button
                      onClick={() => handleAddTags(nowTag)}
                      type="button"
                      className="bg-transparent hover:bg-green-200 text-green-800 font-bold border border-gray-500 py-1 px-2 rounded inline-flex items-center"
                    >
                    ...
                    <button
                      onClick={() => handleAddTags(+1)}
                      type="button"
                      className="bg-transparent hover:bg-blue-500 text-gray-800 font-bold border border-gray-500 py-1 px-2 rounded inline-flex items-center"
                    >
                ...
                <label>Picture</label>
                <UploadForm
                  handleReturnImage={handleReturnImage}
                ...
                <div className="inline">
                  ...
                  <input
                    ...
                    name="price"
                    id="number"
                    className="mt-5 shadow appearance-none border rounded w-3/12 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  ></input>
                  <label>baht</label>
                ...
                <button
                  type="submit"
                  className="bg-green-400 hover:bg-green-500 text-white font-semibold py-2 px-4 border border-green-500 hover:border-transparent rounded w-max mb-5 mt-2"
                >
                  Save Product
                </button>
