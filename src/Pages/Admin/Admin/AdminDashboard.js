...
const AdminDashboard = () => {
  return (
    <div class="relative min-h-screen md:flex">
      <Sidebar />
      <div id="admin_dashboard" className="container px-16 bg-blue-50">
        <div className="grid grid-cols-12 gap-x-12">
          <div
            id=""
            className="col-span-12 p-4 bg-white my-8 rounded shadow-md"
          >
            <div className="items-center flex justify-end">
              <i class="fas fa-user pr-4 text-2xl"></i>
          ...
          <div className="col-span-6 my-8 bg-white p-4 rounded shadow-md">
            <p>Summary</p>
            <img
              src="https://via.placeholder.com/674x353"
              className=""
              alt="Summary"
            ></img>
          </div>
