...
const AdminProduct = () => {
  ...
  return (
    <div class="relative min-h-screen md:flex">
      <Sidebar />
      <div
        id="admin_product_table"
        className="container px-16 mx-auto bg-blue-50"
      >
        <div className="grid grid-cols-12 gap-y-4">
          ...
          <div className="col-span-2">
            <Link to={`${path}/create`}>
              <button className="bg-blue-600 text-white px-4 py-2 shadow-md rounded">
